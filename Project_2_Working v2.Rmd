...
##### 4.1.1 ANOVA Results Summarized
...
Overall most Countries exhibit the expected trends of more medals being won in the host year, as well as the subsequent years. Every country has won more medals in the year they host, however, some contries increased their participation so much that their average medals per event dropped. This shows that occasionally the host-effect doesnt actually motivate the host athletes to perform better. Some teams also dont continue their winning streak in the Olympic games after hosting, we can conclude that the Olympics aren't important enough in these countries for hosting to have a lasting effect.

##### 4.1.2 Graphic Examples of Medals won from Greece and China
...
```{r Weightlifting t-test, echo = FALSE, include=FALSE}
# AGE: 
# Females
